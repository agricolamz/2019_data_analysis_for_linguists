...
### 1.1
Дан график логнормального распределения со средним 3 и стандартным отклонением 0.5. Использкйте функцию `integrate`, чтобы посчитать закрашенную площадь под кривой.
