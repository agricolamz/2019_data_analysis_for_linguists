...
Домашние задания у всех общие, однако для каждого студента каждый датасет несколько отличается. Все датасеты собраны в [этой папке](https://github.com/agricolamz/2019_data_analysis_for_linguists/tree/master/data/students), где содержатся подпапки для каждого студента (если, Вы не видете Вашей папки, заполните [эту форму](https://goo.gl/forms/ImsaSzpW1krTnRnJ3) и напишите мне).
...
cd /home/agricolamz/work/materials/2019_I_HSE_Data_Analysis_for_linguists_II/data/answers/creaciond/
tree
```
